...
- (void)application:(UIApplication *)application didRegisterUserNotificationSettings:(UIUserNotificationSettings *)notificationSettings {
    NSLog(@"%s: User enabled notifications, time to register them.", __PRETTY_FUNCTION__);
    [[NSNotificationCenter defaultCenter] postNotificationName:kNotificationsEnabled object:nil];
}

- (void)application:(UIApplication *)application didReceiveLocalNotification:(UILocalNotification *)notification {
    NSLog(@"%s: We received a local notification. Displaying it.", __PRETTY_FUNCTION__);
